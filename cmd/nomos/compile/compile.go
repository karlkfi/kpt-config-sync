...
var Cmd = &cobra.Command{
	Use:   "compile",
	Short: "Compile objects from a Anthos Configuration Management directory",
	Long: `Output compiled objects from a Anthos Configuration Management directory.  This
