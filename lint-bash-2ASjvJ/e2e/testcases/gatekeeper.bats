...
test_constraint_template_and_constraint_in_same_commit() { bats_test_begin "constraint template and constraint in same commit" 24; 
...
bats_test_function test_constraint_template_and_constraint_in_same_commit
