...
test_-24-7bFILE-5fNAME-7d-3a_ClusterSelector-3a_Target_different_ResourceQuotas_to_different_clusters() { bats_test_begin "${FILE_NAME}: ClusterSelector: Target different ResourceQuotas to different clusters" 61; 
...
test_-24-7bFILE-5fNAME-7d-3a_ClusterSelector-3a_Object_reacts_to_per-2dcluster_annotations() { bats_test_begin "${FILE_NAME}: ClusterSelector: Object reacts to per-cluster annotations" 81; 
...
test_-24-7bFILE-5fNAME-7d-3a_ClusterSelector-3a_Namespace_reacts_to_per-2dcluster_annotations() { bats_test_begin "${FILE_NAME}: ClusterSelector: Namespace reacts to per-cluster annotations" 115; 
  add_clusterregistry_data
...
test_-24-7bFILE-5fNAME-7d-3a_ClusterSelector-3a_Object_reacts_to_changing_the_selector() { bats_test_begin "${FILE_NAME}: ClusterSelector: Object reacts to changing the selector" 152; 
  add_clusterregistry_data
...
test_-24-7bFILE-5fNAME-7d-3a_ClusterSelector-3a_Cluster_reacts_to_CLUSTER-5fNAME_change() { bats_test_begin "${FILE_NAME}: ClusterSelector: Cluster reacts to CLUSTER_NAME change" 174; 
  debug::log "Require that the cluster name exists on the cluster"
  wait::for -t 10 -- kubectl get configmaps -n config-management-system cluster-name
...
test_-24-7bFILE-5fNAME-7d-3a_ClusterSelector-3a_Importer_ignores_non-2dselected_custom_resources() { bats_test_begin "${FILE_NAME}: ClusterSelector: Importer ignores non-selected custom resources" 208; 
  debug::log "Require that the cluster name exists on the cluster"
  wait::for -t 10 -- kubectl get configmaps -n config-management-system cluster-name
...
bats_test_function test_-24-7bFILE-5fNAME-7d-3a_ClusterSelector-3a_Target_different_ResourceQuotas_to_different_clusters
bats_test_function test_-24-7bFILE-5fNAME-7d-3a_ClusterSelector-3a_Object_reacts_to_per-2dcluster_annotations
bats_test_function test_-24-7bFILE-5fNAME-7d-3a_ClusterSelector-3a_Namespace_reacts_to_per-2dcluster_annotations
bats_test_function test_-24-7bFILE-5fNAME-7d-3a_ClusterSelector-3a_Object_reacts_to_changing_the_selector
bats_test_function test_-24-7bFILE-5fNAME-7d-3a_ClusterSelector-3a_Cluster_reacts_to_CLUSTER-5fNAME_change
bats_test_function test_-24-7bFILE-5fNAME-7d-3a_ClusterSelector-3a_Importer_ignores_non-2dselected_custom_resources
