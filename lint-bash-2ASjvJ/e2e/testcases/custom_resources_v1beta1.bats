...
test_-24-7bFILE-5fNAME-7d-3a_CRD_deleted_before_repo_update() { bats_test_begin "${FILE_NAME}: CRD deleted before repo update" 35; 
...
test_-24-7bFILE-5fNAME-7d-3a_Sync_and_update_structural_custom_resource() { bats_test_begin "${FILE_NAME}: Sync and update structural custom resource" 60; 
  local resname="e2e-test-anvil"
