...
test_-24-7bFILE-5fNAME-7d-3a_Preserve_autogenerated_fields_when_syncing_services() { bats_test_begin "${FILE_NAME}: Preserve autogenerated fields when syncing services" 28; 
...
test_-24-7bFILE-5fNAME-7d-3a_Preserve_autogenerated_fields_when_syncing_ClusterRoles_with_aggregation() { bats_test_begin "${FILE_NAME}: Preserve autogenerated fields when syncing ClusterRoles with aggregation" 79; 
...
test_-24-7bFILE-5fNAME-7d-3a_Preserve_and_migrate_contents_of_old_last-2dapplied-2dconfiguration_annotation() { bats_test_begin "${FILE_NAME}: Preserve and migrate contents of old last-applied-configuration annotation" 113; 
...
test_-24-7bFILE-5fNAME-7d-3a_Add-2fUpdate-2fDelete_labels() { bats_test_begin "${FILE_NAME}: Add/Update/Delete labels" 149; 
...
test_-24-7bFILE-5fNAME-7d-3a_Add-2fUpdate-2fDelete_annotations() { bats_test_begin "${FILE_NAME}: Add/Update/Delete annotations" 212; 
  local resname="e2e-test-configmap"
...
bats_test_function test_-24-7bFILE-5fNAME-7d-3a_Preserve_autogenerated_fields_when_syncing_services
bats_test_function test_-24-7bFILE-5fNAME-7d-3a_Preserve_autogenerated_fields_when_syncing_ClusterRoles_with_aggregation
bats_test_function test_-24-7bFILE-5fNAME-7d-3a_Preserve_and_migrate_contents_of_old_last-2dapplied-2dconfiguration_annotation
bats_test_function test_-24-7bFILE-5fNAME-7d-3a_Add-2fUpdate-2fDelete_labels
bats_test_function test_-24-7bFILE-5fNAME-7d-3a_Add-2fUpdate-2fDelete_annotations
