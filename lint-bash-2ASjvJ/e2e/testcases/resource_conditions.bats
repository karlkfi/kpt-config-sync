...
test_-24-7bFILE-5fNAME-7d-3a_Resource_condition_annotations() { bats_test_begin "${FILE_NAME}: Resource condition annotations" 72; 
  ...
  wait::for -l -t 10 -- clusterconfig_condition "Error"
  ...
  wait::for -l -t 10 -- clusterconfig_condition "Reconciling"
...
test_-24-7bFILE-5fNAME-7d-3a_constraint_template_gets_status_annotations() { bats_test_begin "${FILE_NAME}: constraint template gets status annotations" 179; 
...
test_-24-7bFILE-5fNAME-7d-3a_constraint_gets_status_annotations() { bats_test_begin "${FILE_NAME}: constraint gets status annotations" 197; 
...
bats_test_function test_-24-7bFILE-5fNAME-7d-3a_Resource_condition_annotations
bats_test_function test_-24-7bFILE-5fNAME-7d-3a_constraint_template_gets_status_annotations
bats_test_function test_-24-7bFILE-5fNAME-7d-3a_constraint_gets_status_annotations
