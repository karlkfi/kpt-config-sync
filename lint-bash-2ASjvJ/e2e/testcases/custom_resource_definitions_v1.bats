...
test_-24-7bFILE-5fNAME-7d-3a_CRD_added-2c_CR_added-2c_CRD_removed-2c_and_then_CR_removed_from_repo() { bats_test_begin "${FILE_NAME}: CRD added, CR added, CRD removed, and then CR removed from repo" 34; 
...
test_-24-7bFILE-5fNAME-7d-3a_namespace-2dscoped_CRD_and_CR_added-2c_CRD_updated-2c_and_both_removed_from_repo() { bats_test_begin "${FILE_NAME}: namespace-scoped CRD and CR added, CRD updated, and both removed from repo" 73; 
  if (( MINOR_VERSION < 16 )); then
    skip
  fi
...
test_-24-7bFILE-5fNAME-7d-3a_cluster-2dscoped_CRD_and_CR_added-2c_CRD_updated-2c_and_both_removed_from_repo() { bats_test_begin "${FILE_NAME}: cluster-scoped CRD and CR added, CRD updated, and both removed from repo" 150; 
  if (( MINOR_VERSION < 16 )); then
    skip
  fi
...
test_-24-7bFILE-5fNAME-7d-3a_CRD_added-2c_unmanaged_CR_added-2c_and_CRD_removed_which_removes_CR_from_cluster() { bats_test_begin "${FILE_NAME}: CRD added, unmanaged CR added, and CRD removed which removes CR from cluster" 202; 
  if (( MINOR_VERSION < 16 )); then
    skip
  fi
...
test_-24-7bFILE-5fNAME-7d-3a_CRD_added-2c_CR_added-2c_CRD_removed-2c_which_causes_vet_failure() { bats_test_begin "${FILE_NAME}: CRD added, CR added, CRD removed, which causes vet failure" 231; 
  if (( MINOR_VERSION < 16 )); then
    skip
  fi
