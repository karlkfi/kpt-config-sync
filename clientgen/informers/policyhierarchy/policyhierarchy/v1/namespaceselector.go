...
func NewNamespaceSelectorInformer(client policyhierarchy.Interface, resyncPeriod time.Duration, indexers cache.Indexers) cache.SharedIndexInformer {
...
// Always prefer using an informer factory to get a shared informer instead of getting an independent
// one. This reduces memory footprint and number of connections to the server.
func NewFilteredNamespaceSelectorInformer(client policyhierarchy.Interface, resyncPeriod time.Duration, indexers cache.Indexers, tweakListOptions internalinterfaces.TweakListOptionsFunc) cache.SharedIndexInformer {
...
func (f *namespaceSelectorInformer) defaultInformer(client policyhierarchy.Interface, resyncPeriod time.Duration) cache.SharedIndexInformer {
...
func (f *namespaceSelectorInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&policyhierarchy_v1.NamespaceSelector{}, f.defaultInformer)
}
