	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options meta_v1.ListOptions) (runtime.Object, error) {
				...
				return client.ConfigmanagementV1().NamespaceConfigs().List(options)
			},
			WatchFunc: func(options meta_v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.ConfigmanagementV1().NamespaceConfigs().Watch(options)
			},
		},
		&configmanagement_v1.NamespaceConfig{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *namespaceConfigInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&configmanagement_v1.NamespaceConfig{}, f.defaultInformer)
}
