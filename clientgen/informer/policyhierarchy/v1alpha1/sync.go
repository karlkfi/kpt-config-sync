	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.NomosV1alpha1().Syncs().List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.NomosV1alpha1().Syncs().Watch(options)
			},
		},
		&policyhierarchy_v1alpha1.Sync{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *syncInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&policyhierarchy_v1alpha1.Sync{}, f.defaultInformer)
}
