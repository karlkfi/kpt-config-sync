	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.NomosV1alpha1().Repos().List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.NomosV1alpha1().Repos().Watch(options)
			},
		},
		&policyhierarchy_v1alpha1.Repo{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *repoInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&policyhierarchy_v1alpha1.Repo{}, f.defaultInformer)
}
