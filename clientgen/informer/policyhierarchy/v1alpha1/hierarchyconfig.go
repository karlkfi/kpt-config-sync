...
type HierarchyConfigInformer interface {
	...
	Lister() v1alpha1.HierarchyConfigLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.NomosV1alpha1().HierarchyConfigs().List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.NomosV1alpha1().HierarchyConfigs().Watch(options)
			},
		},
		&policyhierarchy_v1alpha1.HierarchyConfig{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *hierarchyConfigInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&policyhierarchy_v1alpha1.HierarchyConfig{}, f.defaultInformer)
}

func (f *hierarchyConfigInformer) Lister() v1alpha1.HierarchyConfigLister {
	return v1alpha1.NewHierarchyConfigLister(f.Informer().GetIndexer())
}
