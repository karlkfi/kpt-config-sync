...
import (
	v1 "github.com/google/nomos/clientgen/policyhierarchy/typed/policyhierarchy/v1"
...
func (c *FakeNomosV1) SyncDeclarations() v1.SyncDeclarationInterface {
	return &FakeSyncDeclarations{c}
}
