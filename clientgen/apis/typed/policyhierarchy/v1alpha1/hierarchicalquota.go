...
type HierarchicalQuotaInterface interface {
	Create(*v1alpha1.HierarchicalQuota) (*v1alpha1.HierarchicalQuota, error)
	Update(*v1alpha1.HierarchicalQuota) (*v1alpha1.HierarchicalQuota, error)
	Delete(name string, options *v1.DeleteOptions) error
	DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error
	Get(name string, options v1.GetOptions) (*v1alpha1.HierarchicalQuota, error)
	List(opts v1.ListOptions) (*v1alpha1.HierarchicalQuotaList, error)
	Watch(opts v1.ListOptions) (watch.Interface, error)
	Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.HierarchicalQuota, err error)
...
func newHierarchicalQuotas(c *NomosV1alpha1Client) *hierarchicalQuotas {
...
func (c *hierarchicalQuotas) Get(name string, options v1.GetOptions) (result *v1alpha1.HierarchicalQuota, err error) {
	result = &v1alpha1.HierarchicalQuota{}
	err = c.client.Get().
...
func (c *hierarchicalQuotas) List(opts v1.ListOptions) (result *v1alpha1.HierarchicalQuotaList, err error) {
	result = &v1alpha1.HierarchicalQuotaList{}
	err = c.client.Get().
		Resource("hierarchicalquotas").
...
func (c *hierarchicalQuotas) Watch(opts v1.ListOptions) (watch.Interface, error) {
	opts.Watch = true
	return c.client.Get().
		Resource("hierarchicalquotas").
		VersionedParams(&opts, scheme.ParameterCodec).
...
func (c *hierarchicalQuotas) Create(hierarchicalQuota *v1alpha1.HierarchicalQuota) (result *v1alpha1.HierarchicalQuota, err error) {
	result = &v1alpha1.HierarchicalQuota{}
	err = c.client.Post().
		Resource("hierarchicalquotas").
...
func (c *hierarchicalQuotas) Update(hierarchicalQuota *v1alpha1.HierarchicalQuota) (result *v1alpha1.HierarchicalQuota, err error) {
	result = &v1alpha1.HierarchicalQuota{}
	err = c.client.Put().
		Resource("hierarchicalquotas").
...
func (c *hierarchicalQuotas) Delete(name string, options *v1.DeleteOptions) error {
...
func (c *hierarchicalQuotas) DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error {
	return c.client.Delete().
		Resource("hierarchicalquotas").
...
func (c *hierarchicalQuotas) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.HierarchicalQuota, err error) {
	result = &v1alpha1.HierarchicalQuota{}
