...
var syncsResource = schema.GroupVersionResource{Group: "nomos.dev", Version: "v1alpha1", Resource: "syncs"}

var syncsKind = schema.GroupVersionKind{Group: "nomos.dev", Version: "v1alpha1", Kind: "Sync"}
...
func (c *FakeSyncs) Get(name string, options v1.GetOptions) (result *v1alpha1.Sync, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootGetAction(syncsResource, name), &v1alpha1.Sync{})
	if obj == nil {
		return nil, err
	}
...
func (c *FakeSyncs) List(opts v1.ListOptions) (result *v1alpha1.SyncList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootListAction(syncsResource, syncsKind, opts), &v1alpha1.SyncList{})
	if obj == nil {
		return nil, err
	}
...
func (c *FakeSyncs) Create(sync *v1alpha1.Sync) (result *v1alpha1.Sync, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootCreateAction(syncsResource, sync), &v1alpha1.Sync{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.Sync), err
...
func (c *FakeSyncs) Update(sync *v1alpha1.Sync) (result *v1alpha1.Sync, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootUpdateAction(syncsResource, sync), &v1alpha1.Sync{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.Sync), err
...
func (c *FakeSyncs) UpdateStatus(sync *v1alpha1.Sync) (*v1alpha1.Sync, error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootUpdateSubresourceAction(syncsResource, "status", sync), &v1alpha1.Sync{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.Sync), err
...
func (c *FakeSyncs) Delete(name string, options *v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewRootDeleteAction(syncsResource, name), &v1alpha1.Sync{})
	return err
}
...
func (c *FakeSyncs) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.Sync, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootPatchSubresourceAction(syncsResource, name, data, subresources...), &v1alpha1.Sync{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.Sync), err
