...
func (c *FakeRepos) Get(name string, options v1.GetOptions) (result *policyhierarchy_v1.Repo, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootGetAction(reposResource, name), &policyhierarchy_v1.Repo{})
	if obj == nil {
		return nil, err
	}
	return obj.(*policyhierarchy_v1.Repo), err
}

// List takes label and field selectors, and returns the list of Repos that match those selectors.
func (c *FakeRepos) List(opts v1.ListOptions) (result *policyhierarchy_v1.RepoList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootListAction(reposResource, reposKind, opts), &policyhierarchy_v1.RepoList{})
	if obj == nil {
		return nil, err
	}
	...
	list := &policyhierarchy_v1.RepoList{ListMeta: obj.(*policyhierarchy_v1.RepoList).ListMeta}
	for _, item := range obj.(*policyhierarchy_v1.RepoList).Items {
...
func (c *FakeRepos) Create(repo *policyhierarchy_v1.Repo) (result *policyhierarchy_v1.Repo, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootCreateAction(reposResource, repo), &policyhierarchy_v1.Repo{})
	if obj == nil {
		return nil, err
	}
	return obj.(*policyhierarchy_v1.Repo), err
...
func (c *FakeRepos) Update(repo *policyhierarchy_v1.Repo) (result *policyhierarchy_v1.Repo, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootUpdateAction(reposResource, repo), &policyhierarchy_v1.Repo{})
	if obj == nil {
		return nil, err
	}
	return obj.(*policyhierarchy_v1.Repo), err
...
func (c *FakeRepos) Delete(name string, options *v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewRootDeleteAction(reposResource, name), &policyhierarchy_v1.Repo{})
	return err
}
...
func (c *FakeRepos) DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error {
	...
	_, err := c.Fake.Invokes(action, &policyhierarchy_v1.RepoList{})
	return err
}

// Patch applies the patch and returns the patched repo.
func (c *FakeRepos) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *policyhierarchy_v1.Repo, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootPatchSubresourceAction(reposResource, name, data, subresources...), &policyhierarchy_v1.Repo{})
	if obj == nil {
		return nil, err
	}
	return obj.(*policyhierarchy_v1.Repo), err
