...
func (c *FakeSyncs) Get(name string, options v1.GetOptions) (result *nomos_v1.Sync, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootGetAction(syncsResource, name), &nomos_v1.Sync{})
	if obj == nil {
		return nil, err
	}
	return obj.(*nomos_v1.Sync), err
}

// List takes label and field selectors, and returns the list of Syncs that match those selectors.
func (c *FakeSyncs) List(opts v1.ListOptions) (result *nomos_v1.SyncList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootListAction(syncsResource, syncsKind, opts), &nomos_v1.SyncList{})
	if obj == nil {
		return nil, err
	}
	...
	list := &nomos_v1.SyncList{}
	for _, item := range obj.(*nomos_v1.SyncList).Items {
...
func (c *FakeSyncs) Create(sync *nomos_v1.Sync) (result *nomos_v1.Sync, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootCreateAction(syncsResource, sync), &nomos_v1.Sync{})
	if obj == nil {
		return nil, err
	}
	return obj.(*nomos_v1.Sync), err
...
func (c *FakeSyncs) Update(sync *nomos_v1.Sync) (result *nomos_v1.Sync, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootUpdateAction(syncsResource, sync), &nomos_v1.Sync{})
	if obj == nil {
		return nil, err
	}
	return obj.(*nomos_v1.Sync), err
...
func (c *FakeSyncs) UpdateStatus(sync *nomos_v1.Sync) (*nomos_v1.Sync, error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootUpdateSubresourceAction(syncsResource, "status", sync), &nomos_v1.Sync{})
	if obj == nil {
		return nil, err
	}
	return obj.(*nomos_v1.Sync), err
...
func (c *FakeSyncs) Delete(name string, options *v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewRootDeleteAction(syncsResource, name), &nomos_v1.Sync{})
	return err
}
...
func (c *FakeSyncs) DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error {
	...
	_, err := c.Fake.Invokes(action, &nomos_v1.SyncList{})
	return err
}

// Patch applies the patch and returns the patched sync.
func (c *FakeSyncs) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *nomos_v1.Sync, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootPatchSubresourceAction(syncsResource, name, data, subresources...), &nomos_v1.Sync{})
	if obj == nil {
		return nil, err
	}
	return obj.(*nomos_v1.Sync), err
