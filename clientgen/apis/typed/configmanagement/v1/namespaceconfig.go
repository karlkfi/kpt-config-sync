...
type NamespaceConfigInterface interface {
	...
	Get(name string, options metav1.GetOptions) (*v1.NamespaceConfig, error)
	List(opts metav1.ListOptions) (*v1.NamespaceConfigList, error)
...
func (c *namespaceConfigs) Get(name string, options metav1.GetOptions) (result *v1.NamespaceConfig, err error) {
...
func (c *namespaceConfigs) List(opts metav1.ListOptions) (result *v1.NamespaceConfigList, err error) {
...
func (c *namespaceConfigs) Watch(opts metav1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *namespaceConfigs) Delete(name string, options *metav1.DeleteOptions) error {
...
func (c *namespaceConfigs) DeleteCollection(options *metav1.DeleteOptions, listOptions metav1.ListOptions) error {
	var timeout time.Duration
