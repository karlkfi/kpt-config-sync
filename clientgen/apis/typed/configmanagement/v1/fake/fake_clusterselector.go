...
func (c *FakeClusterSelectors) Get(name string, options v1.GetOptions) (result *configmanagement_v1.ClusterSelector, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootGetAction(clusterselectorsResource, name), &configmanagement_v1.ClusterSelector{})
	if obj == nil {
		return nil, err
	}
	return obj.(*configmanagement_v1.ClusterSelector), err
}

// List takes label and field selectors, and returns the list of ClusterSelectors that match those selectors.
func (c *FakeClusterSelectors) List(opts v1.ListOptions) (result *configmanagement_v1.ClusterSelectorList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootListAction(clusterselectorsResource, clusterselectorsKind, opts), &configmanagement_v1.ClusterSelectorList{})
	if obj == nil {
		return nil, err
	}
	...
	list := &configmanagement_v1.ClusterSelectorList{ListMeta: obj.(*configmanagement_v1.ClusterSelectorList).ListMeta}
	for _, item := range obj.(*configmanagement_v1.ClusterSelectorList).Items {
...
func (c *FakeClusterSelectors) Create(clusterSelector *configmanagement_v1.ClusterSelector) (result *configmanagement_v1.ClusterSelector, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootCreateAction(clusterselectorsResource, clusterSelector), &configmanagement_v1.ClusterSelector{})
	if obj == nil {
		return nil, err
	}
	return obj.(*configmanagement_v1.ClusterSelector), err
...
func (c *FakeClusterSelectors) Update(clusterSelector *configmanagement_v1.ClusterSelector) (result *configmanagement_v1.ClusterSelector, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootUpdateAction(clusterselectorsResource, clusterSelector), &configmanagement_v1.ClusterSelector{})
	if obj == nil {
		return nil, err
	}
	return obj.(*configmanagement_v1.ClusterSelector), err
...
func (c *FakeClusterSelectors) Delete(name string, options *v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewRootDeleteAction(clusterselectorsResource, name), &configmanagement_v1.ClusterSelector{})
	return err
}
...
func (c *FakeClusterSelectors) DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error {
	...
	_, err := c.Fake.Invokes(action, &configmanagement_v1.ClusterSelectorList{})
	return err
}

// Patch applies the patch and returns the patched clusterSelector.
func (c *FakeClusterSelectors) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *configmanagement_v1.ClusterSelector, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootPatchSubresourceAction(clusterselectorsResource, name, data, subresources...), &configmanagement_v1.ClusterSelector{})
	if obj == nil {
		return nil, err
	}
	return obj.(*configmanagement_v1.ClusterSelector), err
