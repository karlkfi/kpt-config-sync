...
import (
	...
	policyinformer "github.com/google/nomos/clientgen/informers/externalversions/policyhierarchy/v1"
...
func (p *Admitter) clusterPolicyAdmit(request admissionv1beta1.AdmissionRequest) *admissionv1beta1.AdmissionResponse {
	...
	var clusterPolicy *policyhierarchy_v1.ClusterPolicy
	if obj := attributes.GetObject(); obj == nil {
		...
		var ok bool
		clusterPolicy, ok = obj.(*policyhierarchy_v1.ClusterPolicy)
		if !ok {
