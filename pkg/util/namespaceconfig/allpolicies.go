...
type AllPolicies struct {
	...
	// +optional
	NamespaceConfigs map[string]v1.NamespaceConfig `protobuf:"bytes,1,rep,name=policyNodes"`
	// +optional
	ClusterConfig *v1.ClusterConfig `protobuf:"bytes,2,opt,name=clusterPolicy"`
