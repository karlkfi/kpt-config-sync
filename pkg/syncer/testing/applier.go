...
import (
	...
	id "github.com/google/nomos/pkg/importer/id"
...
func (m *MockApplier) Create(ctx context.Context, obj *unstructured.Unstructured) (bool, id.ResourceError) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Create", ctx, obj)
	ret0, _ := ret[0].(bool)
	ret1, _ := ret[1].(id.ResourceError)
	return ret0, ret1
}
...
func (m *MockApplier) Update(ctx context.Context, intendedState, currentState *unstructured.Unstructured) (bool, id.ResourceError) {
	m.ctrl.T.Helper()
...
func (m *MockApplier) Delete(ctx context.Context, obj *unstructured.Unstructured) (bool, id.ResourceError) {
	m.ctrl.T.Helper()
