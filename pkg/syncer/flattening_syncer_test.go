...
func TestFlatteningSyncerRoleBindings(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			...
			expectedActions: []string{"rbac.authorization.k8s.io/v1/RoleBindings/acme/from-acme/upsert"},
		},
		{
			...
			expectedActions: []string{
				"rbac.authorization.k8s.io/v1/RoleBindings/eng/from-acme/upsert",
				"rbac.authorization.k8s.io/v1/RoleBindings/eng/from-eng/upsert",
			},
		},
		{
			name:    "Acme create",
			...
			expectedActions: []string{
				"rbac.authorization.k8s.io/v1/RoleBindings/eng/from-acme/upsert",
				"rbac.authorization.k8s.io/v1/RoleBindings/eng/from-eng/upsert",
				"rbac.authorization.k8s.io/v1/RoleBindings/prod/from-acme/upsert",
				"rbac.authorization.k8s.io/v1/RoleBindings/prod/from-prod/upsert",
				"rbac.authorization.k8s.io/v1/RoleBindings/frontend/from-acme/upsert",
				"rbac.authorization.k8s.io/v1/RoleBindings/frontend/from-eng/upsert",
				"rbac.authorization.k8s.io/v1/RoleBindings/frontend/from-frontend/upsert",
				"rbac.authorization.k8s.io/v1/RoleBindings/backend/from-acme/upsert",
				"rbac.authorization.k8s.io/v1/RoleBindings/backend/from-eng/upsert",
				"rbac.authorization.k8s.io/v1/RoleBindings/backend/from-backend/upsert",
			},
		},
		{
			name:    "Acme update",
			...
			expectedActions: []string{
				...
				"rbac.authorization.k8s.io/v1/RoleBindings/backend/from-eng/upsert",
				"rbac.authorization.k8s.io/v1/RoleBindings/backend/from-backend/upsert",
				"rbac.authorization.k8s.io/v1/RoleBindings/prj/from-acme/upsert",
				"rbac.authorization.k8s.io/v1/RoleBindings/prj/from-prod/upsert",
				"rbac.authorization.k8s.io/v1/RoleBindings/prj/from-prj/upsert",
				"rbac.authorization.k8s.io/v1/RoleBindings/prj/from-prod/delete",
				// Repeated inserts, perhaps inefficient.
				"rbac.authorization.k8s.io/v1/RoleBindings/prj/from-acme/upsert",
				"rbac.authorization.k8s.io/v1/RoleBindings/prj/from-eng/upsert",
				"rbac.authorization.k8s.io/v1/RoleBindings/prj/from-frontend/upsert",
				"rbac.authorization.k8s.io/v1/RoleBindings/prj/from-prj/upsert",
			},
		},
		{
			...
			expectedActions: []string{
				"rbac.authorization.k8s.io/v1/RoleBindings/acme/from-acme/upsert", // 0
				"rbac.authorization.k8s.io/v1/RoleBindings/eng/from-acme/upsert",
				"rbac.authorization.k8s.io/v1/RoleBindings/eng/from-eng/upsert",
				"rbac.authorization.k8s.io/v1/RoleBindings/frontend/from-acme/upsert",
				"rbac.authorization.k8s.io/v1/RoleBindings/frontend/from-eng/upsert",
				"rbac.authorization.k8s.io/v1/RoleBindings/frontend/from-frontend/upsert", // 5
				"rbac.authorization.k8s.io/v1/RoleBindings/backend/from-acme/upsert",
				"rbac.authorization.k8s.io/v1/RoleBindings/backend/from-eng/upsert",
				"rbac.authorization.k8s.io/v1/RoleBindings/backend/from-backend/upsert",
				"rbac.authorization.k8s.io/v1/RoleBindings/prod/from-acme/upsert",
				"rbac.authorization.k8s.io/v1/RoleBindings/prod/from-prod/upsert", // 10
				"rbac.authorization.k8s.io/v1/RoleBindings/prj/from-acme/upsert",
				"rbac.authorization.k8s.io/v1/RoleBindings/prj/from-prod/upsert",
				"rbac.authorization.k8s.io/v1/RoleBindings/prj/from-prj/upsert",
				// Deleting the node "eng" removes "eng" and all the policies
				// in it, and all the policies in its child nodes.
				"rbac.authorization.k8s.io/v1/RoleBindings/backend/from-acme/delete",
				"rbac.authorization.k8s.io/v1/RoleBindings/backend/from-eng/delete",
				"rbac.authorization.k8s.io/v1/RoleBindings/backend/from-backend/delete",
				"rbac.authorization.k8s.io/v1/RoleBindings/eng/from-acme/delete",
				"rbac.authorization.k8s.io/v1/RoleBindings/eng/from-eng/delete",
				"rbac.authorization.k8s.io/v1/RoleBindings/frontend/from-acme/delete",
				"rbac.authorization.k8s.io/v1/RoleBindings/frontend/from-eng/delete",
				"rbac.authorization.k8s.io/v1/RoleBindings/frontend/from-frontend/delete",
			},
		},
		{
		...
		},
		{
			...
			expectedActions: []string{
				"rbac.authorization.k8s.io/v1/RoleBindings/acme/from-acme/upsert",
				"rbac.authorization.k8s.io/v1/RoleBindings/eng/from-acme/upsert",
				"rbac.authorization.k8s.io/v1/RoleBindings/eng/from-eng/upsert",
				"rbac.authorization.k8s.io/v1/RoleBindings/frontend/from-acme/upsert",
				"rbac.authorization.k8s.io/v1/RoleBindings/frontend/from-eng/upsert",
		...
		},
		{
			...
			expectedActions: []string{
				"rbac.authorization.k8s.io/v1/RoleBindings/eng/some-unrelated-rolebinding/delete",
				"rbac.authorization.k8s.io/v1/RoleBindings/eng/from-eng/upsert",
				"rbac.authorization.k8s.io/v1/RoleBindings/frontend/from-eng/upsert",
				"rbac.authorization.k8s.io/v1/RoleBindings/frontend/from-frontend/upsert",
			},
...
func TestFlatteningSyncerRoles(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			...
			expectedActions: []string{"rbac.authorization.k8s.io/v1/Roles/acme/from-acme/upsert"},
		},
		{
			name:    "Add-delete-add",
			storage: []runtime.Object{},
			...
			expectedActions: []string{
				"rbac.authorization.k8s.io/v1/Roles/acme/from-acme/upsert",
				"rbac.authorization.k8s.io/v1/Roles/acme/from-acme/delete",
			},
		},
		{
			name:    "Mini acme create",
			...
			expectedActions: []string{
				"rbac.authorization.k8s.io/v1/Roles/eng/from-acme/upsert",
				"rbac.authorization.k8s.io/v1/Roles/eng/from-eng/upsert",
			},
		},
		{
			name:    "Acme create",
			...
			expectedActions: []string{
				"rbac.authorization.k8s.io/v1/Roles/eng/from-acme/upsert",
				"rbac.authorization.k8s.io/v1/Roles/eng/from-eng/upsert",
				"rbac.authorization.k8s.io/v1/Roles/frontend/from-acme/upsert",
				"rbac.authorization.k8s.io/v1/Roles/frontend/from-eng/upsert",
				"rbac.authorization.k8s.io/v1/Roles/frontend/from-frontend/upsert",
				"rbac.authorization.k8s.io/v1/Roles/backend/from-acme/upsert",
				"rbac.authorization.k8s.io/v1/Roles/backend/from-eng/upsert",
				"rbac.authorization.k8s.io/v1/Roles/backend/from-backend/upsert",
			},
		},
		{
			name:    "Acme update",
			...
			expectedActions: []string{
				...
				"rbac.authorization.k8s.io/v1/Roles/backend/from-eng/upsert",
				"rbac.authorization.k8s.io/v1/Roles/backend/from-backend/upsert",
				"rbac.authorization.k8s.io/v1/Roles/prod/from-acme/upsert",
				"rbac.authorization.k8s.io/v1/Roles/prod/from-prod/upsert",
				"rbac.authorization.k8s.io/v1/Roles/prj/from-acme/upsert",
				"rbac.authorization.k8s.io/v1/Roles/prj/from-prod/upsert",
				"rbac.authorization.k8s.io/v1/Roles/prj/from-prj/upsert",
				"rbac.authorization.k8s.io/v1/Roles/prj/from-prod/delete",
				// Repeated inserts, perhaps inefficient.
				"rbac.authorization.k8s.io/v1/Roles/prj/from-acme/upsert",
				"rbac.authorization.k8s.io/v1/Roles/prj/from-eng/upsert",
				"rbac.authorization.k8s.io/v1/Roles/prj/from-frontend/upsert",
				"rbac.authorization.k8s.io/v1/Roles/prj/from-prj/upsert",
			},
		},
		{
			...
			expectedActions: []string{
				...
				"rbac.authorization.k8s.io/v1/Roles/frontend/from-acme/upsert",
				"rbac.authorization.k8s.io/v1/Roles/frontend/from-eng/upsert",
				"rbac.authorization.k8s.io/v1/Roles/frontend/from-frontend/upsert", // 5
				"rbac.authorization.k8s.io/v1/Roles/eng/from-acme/delete",
				"rbac.authorization.k8s.io/v1/Roles/eng/from-eng/delete",
				"rbac.authorization.k8s.io/v1/Roles/frontend/from-acme/delete",
				"rbac.authorization.k8s.io/v1/Roles/frontend/from-eng/delete",
				"rbac.authorization.k8s.io/v1/Roles/frontend/from-frontend/delete",
			},
		},
		{
			name:    "Acme delete",
			...
			expectedActions: []string{
				"rbac.authorization.k8s.io/v1/Roles/acme/from-acme/upsert", // 0
				"rbac.authorization.k8s.io/v1/Roles/eng/from-acme/upsert",
				"rbac.authorization.k8s.io/v1/Roles/eng/from-eng/upsert",
				"rbac.authorization.k8s.io/v1/Roles/frontend/from-acme/upsert",
				"rbac.authorization.k8s.io/v1/Roles/frontend/from-eng/upsert",
				...
				"rbac.authorization.k8s.io/v1/Roles/backend/from-backend/upsert",
				"rbac.authorization.k8s.io/v1/Roles/prod/from-acme/upsert",
				"rbac.authorization.k8s.io/v1/Roles/prod/from-prod/upsert", // 10
				"rbac.authorization.k8s.io/v1/Roles/prj/from-acme/upsert",
				"rbac.authorization.k8s.io/v1/Roles/prj/from-prod/upsert",
				"rbac.authorization.k8s.io/v1/Roles/prj/from-prj/upsert",
				// Deleting the node "eng" removes "eng" and all the policies
				// in it, and all the policies in its child nodes.
				"rbac.authorization.k8s.io/v1/Roles/backend/from-acme/delete",
				"rbac.authorization.k8s.io/v1/Roles/backend/from-eng/delete",
				"rbac.authorization.k8s.io/v1/Roles/backend/from-backend/delete",
				"rbac.authorization.k8s.io/v1/Roles/eng/from-acme/delete",
				"rbac.authorization.k8s.io/v1/Roles/eng/from-eng/delete",
				"rbac.authorization.k8s.io/v1/Roles/frontend/from-acme/delete",
				"rbac.authorization.k8s.io/v1/Roles/frontend/from-eng/delete",
		...
		},
		{
			...
			expectedActions: []string{
				"rbac.authorization.k8s.io/v1/Roles/eng/some-unrelated-rolebinding/delete",
				"rbac.authorization.k8s.io/v1/Roles/eng/from-eng/upsert",
				"rbac.authorization.k8s.io/v1/Roles/frontend/from-eng/upsert",
				"rbac.authorization.k8s.io/v1/Roles/frontend/from-frontend/upsert",
			},
