...
func (in *ClusterPolicyStatus) DeepCopyInto(out *ClusterPolicyStatus) {
	*out = *in
	if in.SyncErrors != nil {
		...
		*out = make([]ClusterSyncError, len(*in))
		copy(*out, *in)
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ClusterSyncError) DeepCopyInto(out *ClusterSyncError) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ClusterSyncError.
func (in *ClusterSyncError) DeepCopy() *ClusterSyncError {
	if in == nil {
		return nil
	}
	out := new(ClusterSyncError)
	in.DeepCopyInto(out)
	return out
}
...
func (in *PolicyNodeStatus) DeepCopyInto(out *PolicyNodeStatus) {
	*out = *in
	...
	if in.SyncErrors != nil {
		in, out := &in.SyncErrors, &out.SyncErrors
		*out = make([]PolicySyncError, len(*in))
		copy(*out, *in)
	}
	in.SyncTime.DeepCopyInto(&out.SyncTime)
	return
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *PolicySyncError) DeepCopyInto(out *PolicySyncError) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new PolicySyncError.
func (in *PolicySyncError) DeepCopy() *PolicySyncError {
	if in == nil {
		return nil
	}
	out := new(PolicySyncError)
	in.DeepCopyInto(out)
	return out
}
