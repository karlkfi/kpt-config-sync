...
func RegisterDeepCopies(scheme *runtime.Scheme) error {
	return scheme.AddGeneratedDeepCopyFuncs(
		conversion.GeneratedDeepCopyFunc{Fn: func(in interface{}, out interface{}, c *conversion.Cloner) error {
			in.(*PolicyLists).DeepCopyInto(out.(*PolicyLists))
			return nil
		}, InType: reflect.TypeOf(&PolicyLists{})},
		conversion.GeneratedDeepCopyFunc{Fn: func(in interface{}, out interface{}, c *conversion.Cloner) error {
...
func (in *PolicyLists) DeepCopyInto(out *PolicyLists) {
	*out = *in
	if in.Roles != nil {
	...
	if in.ResourceQuotas != nil {
		...
		*out = make([]core_v1.ResourceQuotaSpec, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new PolicyLists.
func (in *PolicyLists) DeepCopy() *PolicyLists {
	if in == nil {
		return nil
	}
	out := new(PolicyLists)
