...
func (in *ClusterConfigStatus) DeepCopyInto(out *ClusterConfigStatus) {
	*out = *in
	if in.SyncErrors != nil {
		...
		*out = make([]ClusterConfigSyncError, len(*in))
		copy(*out, *in)
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ClusterConfigSyncError) DeepCopyInto(out *ClusterConfigSyncError) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ClusterConfigSyncError.
func (in *ClusterConfigSyncError) DeepCopy() *ClusterConfigSyncError {
	if in == nil {
		return nil
	}
	out := new(ClusterConfigSyncError)
	in.DeepCopyInto(out)
	return out
}
...
func (in *NamespaceConfigStatus) DeepCopyInto(out *NamespaceConfigStatus) {
	*out = *in
	if in.SyncErrors != nil {
		in, out := &in.SyncErrors, &out.SyncErrors
		*out = make([]NamespaceConfigSyncError, len(*in))
		copy(*out, *in)
	}
	in.SyncTime.DeepCopyInto(&out.SyncTime)
	return
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *NamespaceConfigSyncError) DeepCopyInto(out *NamespaceConfigSyncError) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new NamespaceConfigSyncError.
func (in *NamespaceConfigSyncError) DeepCopy() *NamespaceConfigSyncError {
	if in == nil {
		return nil
	}
	out := new(NamespaceConfigSyncError)
	in.DeepCopyInto(out)
	return out
}
...
func (in *RepoSyncStatus) DeepCopyInto(out *RepoSyncStatus) {
	*out = *in
	...
	if in.InProgress != nil {
		...
		*out = make(map[string][]ConfigManagementError, len(*in))
