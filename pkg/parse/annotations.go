...
func addAnnotationsAndLabels(objs []core.Object, scope declared.Scope, gitRef, gitRepo, commitHash string) {
	for _, obj := range objs {
		...
		core.SetAnnotation(obj, v1.ResourceManagerKey, string(scope))
