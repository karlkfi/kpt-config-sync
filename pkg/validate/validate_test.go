	...
	testCases := []struct {
		...
		},
		{
			...
			want: []ast.FileObject{
				fake.Namespace("namespaces/foo",
					...
					core.Annotation(constants.DeclaredFieldsKey, `{}`),
		...
		},
		{
			...
			want: []ast.FileObject{
				fake.FileObject(crdUnstructured(t, kinds.Anvil(),
					core.Label(configuration.DeclaredVersionLabel, "v1beta1"),
					core.Annotation(constants.DeclaredFieldsKey, `{"f:spec":{"f:group":{},"f:names":{"f:kind":{},"f:plural":{}},"f:scope":{},"f:versions":{}},"f:status":{"f:acceptedNames":{"f:kind":{},"f:plural":{}},"f:conditions":{},"f:storedVersions":{}}}`),
				...
				fake.AnvilAtPath("namespaces/foo/anvil.yaml",
					core.Namespace("foo"),
					core.Label(configuration.DeclaredVersionLabel, "v1"),
					core.Annotation(constants.DeclaredFieldsKey, `{"f:metadata":{"f:annotations":{},"f:labels":{}},"f:spec":{".":{},"f:group":{},"f:names":{".":{},"f:kind":{},"f:plural":{}},"f:scope":{}},"f:status":{".":{},"f:acceptedNames":{".":{},"f:kind":{},"f:plural":{}},"f:conditions":{},"f:storedVersions":{}}}`),
		...
		},
		{
			...
			objs: []ast.FileObject{
				...
				fake.ClusterRoleAtPath("cluster/prod-owner_cr.yaml",
					...
					core.Annotation(constants.ClusterNameSelectorAnnotationKey, "prod")),
				...
				fake.ClusterRoleAtPath("cluster/dev-owner_cr.yaml",
					core.Name("dev-owner"),
					core.Annotation(constants.ClusterNameSelectorAnnotationKey, "dev")),
			...
			want: []ast.FileObject{
				fake.ClusterRoleAtPath("cluster/prod-admin_cr.yaml",
					core.Name("prod-admin"),
					core.Label(configuration.DeclaredVersionLabel, "v1"),
					core.Annotation(constants.DeclaredFieldsKey, `{"f:metadata":{"f:annotations":{"f:configmanagement.gke.io/cluster-selector":{}}},"f:rules":{}}`),
				...
				fake.ClusterRoleAtPath("cluster/prod-owner_cr.yaml",
					core.Name("prod-owner"),
					core.Label(configuration.DeclaredVersionLabel, "v1"),
					core.Annotation(constants.DeclaredFieldsKey, `{"f:metadata":{"f:annotations":{"f:configsync.gke.io/cluster-name-selector":{}}},"f:rules":{}}`),
					core.Annotation(v1.ClusterNameAnnotationKey, "prod"),
					core.Annotation(constants.ClusterNameSelectorAnnotationKey, "prod"),
					core.Annotation(v1.SourcePathAnnotationKey, dir+"/cluster/prod-owner_cr.yaml")),
				fake.Namespace("namespaces/prod-shipping",
					core.Label(configuration.DeclaredVersionLabel, "v1"),
					core.Annotation(constants.DeclaredFieldsKey, `{"f:metadata":{"f:annotations":{"f:configsync.gke.io/cluster-name-selector":{}}}}`),
					core.Annotation(v1.ClusterNameAnnotationKey, "prod"),
					core.Annotation(constants.ClusterNameSelectorAnnotationKey, "prod"),
		...
		},
		{
			...
			want: []ast.FileObject{
				fake.Namespace("namespaces/bar/prod-ns",
					core.Label("env", "prod"),
					core.Label(configuration.DeclaredVersionLabel, "v1"),
					core.Annotation(constants.DeclaredFieldsKey, `{"f:metadata":{"f:labels":{"f:env":{}}}}`),
				...
				fake.RoleBindingAtPath("namespaces/bar/rb.yaml",
					...
					core.Label(configuration.DeclaredVersionLabel, "v1"),
					core.Annotation(constants.DeclaredFieldsKey, `{"f:metadata":{"f:annotations":{"f:configmanagement.gke.io/namespace-selector":{}}},"f:roleRef":{"f:apiGroup":{},"f:kind":{},"f:name":{}}}`),
					core.Annotation(v1.NamespaceSelectorAnnotationKey, "sre-supported"),
		...
		},
		{
			...
			want: []ast.FileObject{
				fake.ClusterRoleBindingAtPath("cluster/foo/crb.yaml",
					core.Label(configuration.DeclaredVersionLabel, "v1"),
					core.Annotation(constants.DeclaredFieldsKey, `{"f:roleRef":{"f:apiGroup":{},"f:kind":{},"f:name":{}}}`),
		...
		},
		{
			...
			objs: []ast.FileObject{
				...
				fake.NamespaceAtPath("namespaces/foo/foo-stg.yaml",
					core.Name("foo"), core.Annotation(constants.ClusterNameSelectorAnnotationKey, "stg-only")),
				fake.NamespaceAtPath("namespaces/foo/foo-test.yaml",
					core.Name("foo"), core.Annotation(constants.ClusterNameSelectorAnnotationKey, "test-only")),
			},
		},
		{
		...
		},
		{
			...
			objs: []ast.FileObject{
				...
				fake.NamespaceSelector(
					...
					core.Annotation(constants.ClusterNameSelectorAnnotationKey, "prod-cluster")),
			},
			wantErrs: fake.Errors(
		...
		},
		{
			...
			objs: []ast.FileObject{
				...
				fake.Role(
					core.Name("second"),
					core.Annotation(constants.DeclaredFieldsKey, "hello")),
			},
			wantErrs: fake.Errors(
		...
		},
		{
			...
			want: []ast.FileObject{
				fake.Namespace("prod-shipping",
					core.Label("sre-supported", "true"),
					core.Label(configuration.DeclaredVersionLabel, "v1"),
					core.Annotation(constants.DeclaredFieldsKey, `{"f:metadata":{"f:labels":{"f:sre-supported":{}}}}`),
					core.Annotation(v1.SourcePathAnnotationKey, dir+"/prod-shipping/namespace.yaml")),
				fake.Namespace("dev-shipping",
					core.Label(configuration.DeclaredVersionLabel, "v1"),
					core.Annotation(constants.DeclaredFieldsKey, `{}`),
				...
				fake.RoleAtPath("sre-role.yaml",
					...
					core.Namespace("prod-shipping"),
					core.Label(configuration.DeclaredVersionLabel, "v1"),
					core.Annotation(constants.DeclaredFieldsKey, `{"f:metadata":{"f:annotations":{"f:configmanagement.gke.io/namespace-selector":{}}},"f:rules":{}}`),
					core.Annotation(v1.NamespaceSelectorAnnotationKey, "sre"),
		...
		},
		{
			...
			want: []ast.FileObject{
				...
				fake.UnstructuredAtPath(
					...
					"foo/validator.yaml",
					core.Namespace("foo"),
					core.Label(configuration.DeclaredVersionLabel, "v1alpha1"),
					core.Annotation(constants.DeclaredFieldsKey, `{"f:metadata":{"f:annotations":{".":{},"f:configmanagement.gke.io/managed":{}},"f:labels":{}}}`),
					core.Annotation(v1.ResourceManagementKey, v1.ResourceManagementDisabled),
