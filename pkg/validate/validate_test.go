		...
		},
		{
			...
			want: []ast.FileObject{
				...
				fake.AnvilAtPath("namespaces/foo/anvil.yaml",
					core.Namespace("foo"),
					core.Label(configuration.DeclaredVersionLabel, "v1"),
					core.Annotation(v1alpha1.DeclaredFieldsKey, `{"f:metadata":{"f:annotations":{},"f:labels":{}},"f:spec":{".":{},"f:group":{},"f:names":{".":{},"f:kind":{},"f:plural":{}},"f:scope":{}},"f:status":{".":{},"f:acceptedNames":{".":{},"f:kind":{},"f:plural":{}},"f:conditions":{},"f:storedVersions":{}}}`),
