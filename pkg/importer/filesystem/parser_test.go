		...
		parsertest.Success("NamespaceSelector",
			testoutput.NewAllConfigs(
				...
				fake.Namespace("namespaces/bar/prod-ns",
					...
					core.Annotation(v1.HierarchyControllerAnnotationKey, v1.ManagedByValue),
					core.Label(v1.DepthLabelRootName+v1.HierarchyControllerDepthSuffix, "2"),
					core.Label("bar"+v1.HierarchyControllerDepthSuffix, "1"),
					core.Label("prod-ns"+v1.HierarchyControllerDepthSuffix, "0"),
				),
				fake.Namespace("namespaces/bar/test-ns",
					...
					core.Label(v1.DepthLabelRootName+v1.HierarchyControllerDepthSuffix, "2"),
					core.Label("bar"+v1.HierarchyControllerDepthSuffix, "1"),
					core.Label("test-ns"+v1.HierarchyControllerDepthSuffix, "0"),
				),
			),
