...
func TestClusterSelectorAnnotationValidator(t *testing.T) {
	testCases := []nht.ValidatorTestCase{
		...
		nht.Fail("V1 CRD with legacy cluster-selector",
			fake.ToCustomResourceDefinitionV1(fake.CustomResourceDefinitionV1Beta1(legacyClusterSelectorAnnotation)),
		),
		nht.Fail("V1 CRD with inline cluster-selector",
			fake.ToCustomResourceDefinitionV1(fake.CustomResourceDefinitionV1Beta1(inlineClusterSelectorAnnotation)),
		),
		// unknown types
