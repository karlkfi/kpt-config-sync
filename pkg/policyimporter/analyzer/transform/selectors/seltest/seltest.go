...
var ProdNamespaceSelector = v1.NamespaceSelector{
...
var SensitiveNamespaceSelector = v1.NamespaceSelector{
	Spec: v1.NamespaceSelectorSpec{
		Selector: metav1.LabelSelector{
...
func Selector(name string, selector metav1.LabelSelector) v1.ClusterSelector {
	return v1.ClusterSelector{
		ObjectMeta: metav1.ObjectMeta{
			Name: name,
		},
