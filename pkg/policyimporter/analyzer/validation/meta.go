...
func checkAnnotations(o ast.FileObject, errorBuilder *multierror.Builder) {
	...
	if len(found) != 0 {
		errorBuilder.Add(vet.IllegalAnnotationDefinitionError{Object: o, Annotations: found})
	}
}
...
func checkLabels(o ast.FileObject, errorBuilder *multierror.Builder) {
	...
	if len(found) != 0 {
		errorBuilder.Add(vet.IllegalLabelDefinitionError{Object: o, Labels: found})
	}
}
