...
func TestLocalConfig(t *testing.T) {
	...
	ns := "local-config"
	nt.Root.Add("acme/namespaces/local-config/ns.yaml",
	...
	nt.Root.CommitAndPush("Adding ConfigMap as local config")
	nt.WaitForRepoSyncs()
	...
	nt.Root.Add(cmPath, cm)
	nt.Root.CommitAndPush("Adding ConfigMap without local-config annotation")
	nt.WaitForRepoSyncs()
	...
	cm = fake.ConfigMapObject(core.Name(cmName), core.Annotation(metadata.LocalConfigAnnotationKey, metadata.LocalConfigValue))
	nt.Root.Add(cmPath, cm)
	nt.Root.CommitAndPush("Changing ConfigMap to local config")
	nt.WaitForRepoSyncs()
...
func TestLocalConfigWithManagementDisabled(t *testing.T) {
	...
	cm := fake.ConfigMapObject(core.Name(cmName))
	nt.Root.Add(cmPath, cm)
	nt.Root.CommitAndPush("Adding ConfigMap")
	nt.WaitForRepoSyncs()
	...
	nt.Root.Add(cmPath, cm)
	nt.Root.CommitAndPush("Disable the management of ConfigMap")
	nt.WaitForRepoSyncs()
	...
	nt.Root.Add(cmPath, cm)
	nt.Root.CommitAndPush("Change the ConfigMap to local config")
	nt.WaitForRepoSyncs()
	...
	cm = fake.ConfigMapObject(core.Name(cmName), core.Annotation(metadata.LocalConfigAnnotationKey, metadata.LocalConfigValue))
	nt.Root.Add(cmPath, cm)
	nt.Root.CommitAndPush("Remove the managed disabled annotation and keep the local-config annotation")
	nt.WaitForRepoSyncs()
