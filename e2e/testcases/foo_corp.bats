...
@test "${FILE_NAME}: All foo-corp created" {
  ...
  resource::check_count -r namespace -a "configmanagement.gke.io/managed=enabled" -c ${#FOOCORP_NAMESPACES[@]}
  ...
  resource::check -n shipping-dev resourcequota backend-quota -a "configmanagement.gke.io/managed=enabled"
  ...
  resource::check -n shipping-staging resourcequota backend-quota -a "configmanagement.gke.io/managed=enabled"
  ...
  resource::check -n shipping-prod resourcequota backend-quota -a "configmanagement.gke.io/managed=enabled"
